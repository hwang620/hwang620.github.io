...
\begin{tabular}{l}
\textbf{\huge \textcolor{titleblue}{Han WANG}} \\
\\
Ph.D. Student @UESTC
\end{tabular}  &  & \begin{tabular}{@{}rr@{}} \textcolor{titleblue}{\includegraphics[width=0.017\linewidth]{imgs/location(1).pdf}} Chengdu, China & \multirow{3}{*}{\includegraphics[width=0.096\linewidth]{imgs/githubpage.pdf}} \\
\includegraphics[width=0.017\linewidth]{imgs/email(1).pdf} wang\_han@std.uestc.edu.cn                     &                   \\
\includegraphics[width=0.017\linewidth]{imgs/home(1).pdf} \href{http://hwang620.github.io}{hwang620.github.io}                            &                   \\
\includegraphics[width=0.017\linewidth]{imgs/phone(1).pdf} (+86)17721886513                                  &                   
\end{tabular}  \\ 
\end{tabular*}
\end{table}
